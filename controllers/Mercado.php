...
class Mercado
{
	...
	public function index()
	{
		...
		$arr = array(
			...
			// 	'librerias/moment/moment.js',
			 	'js/catalogos/mercado.js'
			 )
		);
		$this->view->show("catalogos/mercado.phtml", $arr);
	}
	...
	public function store(){
		...
		$insert = MercadoDAO::Save($data);
		Funciones::imprimeJson($insert);
	}

	public function update(){
		$data = Funciones::getDataPost();
		$update = MercadoDAO::SaveModify($data);
