...
class Proyecto
{
	const PATH_RESULTADOS = "Proyecto/";
	...
	public function index()
	{
		...
		$arr = array(
			...
			// 	'librerias/moment/moment.js',
			 	'js/catalogos/proyecto.js'
			 )
		);
		$this->view->show("catalogos/proyecto.phtml", $arr);
	}


	public function show(){
		$Tecnologia = ProyectoAsociadoDAO::All();
	...
	public function store(){
		...
		$insert = ProyectoAsociadoDAO::Save($data);
		Funciones::imprimeJson($insert);
	}

	public function update(){
		$data = Funciones::getDataPost();
		$update = ProyectoAsociadoDAO::SaveModify($data);
