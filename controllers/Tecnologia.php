...
class Tecnologia
{
	const PATH_RESULTADOS = "Tecnologia/";
	...
	public function index()
	{
		...
		$arr = array(
			...
			// 	'librerias/moment/moment.js',
			 	'js/catalogos/tecnologia.js'
			 )
		);
		$this->view->show("catalogos/tecnologia.phtml", $arr);
	}


	public function show(){
		$Tecnologia = TecnologiaEquipoDAO::All();
	...
	public function store(){
		...
		$insert = TecnologiaEquipoDAO::Save($data);
		Funciones::imprimeJson($insert);
	}

	public function update(){
		$data = Funciones::getDataPost();
		$update = TecnologiaEquipoDAO::SaveModify($data);
