...
class EvaluacionesDAO
{
	...
	public static function EditarEvaluacionProceso($data){
		...
		try{
			...
			$sql = "UPDATE so_sol 
			SET al = :al, no = :no, ac = :ac, pv = :pv, ts = :ts, pr = :pr, fs = :fs, ig = :ig, me = :me, nu = :nu, pa = :pa, sg = :sg, te = :te, dl = :dl, ft = :ft, pd = :pd, ob = :ob, pe = :pe, spe = :spe, se = :se, fo = :fo WHERE ix = :ix";
			...
			Conexion::$prepare->bindParam(':se', $data['se']);
	...
	public static function AceptarEvaluacion($data){
		...
		try{
			...
			$sql = "UPDATE so_sol SET pv = :pv, ts = :ts, pr = :pr, fo = :fo, sg = :sg, ig = :ig, te = :te, nu = :nu, pa = :pa, me = :me, et = :et, fa = :fa, ft = :ft, dl = :dl, pe = :pe, spe = :spe, se = :se WHERE id = :id";
			Conexion::$connect = new Conexion();
